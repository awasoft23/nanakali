    ...
    <div style="border: 1px solid black; " class="rounded-md overflow-hidden">
        ...
        <div style="padding: 20px">
            ...
            <div class="mt-2 pb-2 grid grid-cols-3 items-center align-middle "
                ...
                <div>
                    <b>بڕ: </b> <span
                        style="border-bottom: 1px #2c3862 dashed; padding-bottom: 2px">{{ number_format($data->amount) }}
                        {{ $data->priceType == 0 ? '$' : 'د،ع' }} </span>
                </div>

                <div class="text-left">

                </div>
                <div style="color: red" class="text-left text-base">
