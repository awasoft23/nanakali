...
class Invoice extends Page
{
    ...
    public function mount(): void
    {
        ...
        $this->data = SellingInvoice::join('customers', 'customers.id', 'selling_invoices.customers_id')
            ->Select('customers.name', 'customers.phone', 'selling_invoices.id','selling_invoices.images', 'selling_invoices.created_at', 'selling_invoices.paymented', 'selling_invoices.priceType', 'selling_invoices.dolarPrice')
        ...
        $this->invoiceProducts = SellingInvoiceProducts::
            ...
            ->select('selling_invoice_products.sallingPrice', 'selling_invoice_products.qty','selling_invoice_products.colorCode', 'selling_products.name', 'selling_products.code', 'selling_products.unit', 'selling_products.colorCofe')
            ->get();
